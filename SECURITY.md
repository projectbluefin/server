...
- The OS DDI payload, the offline installer disk image, and the Kubernetes
  `systemd-sysext`.
...
freedesktop-sdk, GNOME build metadata, systemd, or Kubernetes itself. Report those to
