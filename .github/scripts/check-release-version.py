...
The Kubernetes sysext is deliberately *not* on this axis: it is an
independently-pinned third-party payload versioned from
`include/kubernetes.yml` and enforced separately by
`.github/scripts/check-kubernetes-version.py`.
